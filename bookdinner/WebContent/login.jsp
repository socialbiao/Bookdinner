...
<html>
	...
	<body>
		<div id="Layer1" style="position:absolute; left:610px; top:247px; width:400px; height:131px; z-index:1">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td width="15%" height="22">
							<span style="font-size: 18px;font-weight: 700;">账号:</span>
						</td>
					...
					<tr>
						<td width="15%" height="22">
							<span style="font-size: 18px;font-weight: 700;">密码:</span>
						</td>
						<td width="85%" height="22">
